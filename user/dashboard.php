      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="dash">
           <ul class="nav navbar-nav navbar-right">
               ...
               <li><a href="<?php echo $_SERVER['PHP_SELF'].'?page=listing'; ?>">Item list</a></li>
               <li><a href="<?php echo $_SERVER['PHP_SELF'].'?page=paid'; ?>">Items purchased</a></li>
               <li><a href="<?php echo $_SERVER['PHP_SELF'].'?page=cart'; ?>">My Cart (<?=(isset($_SESSION['COUNT']))? $_SESSION['COUNT'] : 0?>) </a></li>
               <li><a href="<?php echo $_SERVER['PHP_SELF'].'?lougout=true';?>">Logout</a></li>
           </ul>
        </div>
      </div>
    </nav>
